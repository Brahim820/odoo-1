...
class WizradHrPayslipSPI(models.TransientModel):
    ...
    def get_spi(self):
        ...
        for row in self:
            ...
            date = datetime.strptime(self.payment_date, "%Y-%m-%d").strftime("%d%m%y")
            ...
            if not slip_ids:
                raise UserError(_("Error"), _("No slip generates for this month"))
            ...
            if not row.slip_id.bank_transfer_ids:
                batch_payment = {
