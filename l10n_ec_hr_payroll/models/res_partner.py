...
class ResPartner(models.Model):
    ...
    _defaults = {
        ...
        "vat": lambda self, cr, uid, context: context.get("employee_identification")
        or context.get("employee_passport"),
    }
...
class ResPartnerBank(models.Model):
    ...
    _defaults = {"partner_id": lambda self, cr, uid, ctx: ctx.get("partner_id", False)}
