...
class AccountStatementLineCreate(models.TransientModel):
    ...
    def _prepare_move_line_domain(self):
        ...
        if self.journal_ids:
            accounts = self.journal_ids.mapped('default_debit_account_id')
            accounts | self.journal_ids.mapped('default_credit_account_id')
            domain += [('journal_id', 'in', self.journal_ids.ids), ('account_id', 'in', accounts.ids)]
        else:
