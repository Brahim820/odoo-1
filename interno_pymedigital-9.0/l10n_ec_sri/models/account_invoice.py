...
class AccountInvoice(models.Model):
    ...
    def set_liquidacion(self, aut):
        """
        Registra los valores en caso de liquidaciself.r_autorizacion_id and ones de compra.
    ...
    def set_autorizacion(self):
        ...
        if tipo in ('f', 'nc') and self.autorizacion_id and self.secuencial:
            return self.autorizacion_id, tipo
        # o la autorización de la retención.
        elif tipo == 'r' and self.r_autorizacion_id and self.secretencion1:
